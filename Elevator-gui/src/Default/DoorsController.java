...
public class DoorsController implements RiJStateConcept {
    ...
    //## auto_generated 
    public  DoorsController(RiJThread p_thread) {
    ...
    public class Reactive extends RiJStateReactive {
        ...
        public int Waiting_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(DoorsOpened.DoorsOpened_Default_id))
                {
                    res = WaitingTakeDoorsOpened();
                }
        ...
        //## statechart_method 
        public int WaitingTakeDoorsOpened() {
            ...
            if((level == params.level) && !el.moving) {
            	...
            	el.gen(new DoorsOpened(params.level, params.areOpened));
            }
            //#]
